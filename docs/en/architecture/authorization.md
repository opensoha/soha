...
- visible child menus automatically pull their enabled ancestors into the returned tree so the sidebar remains navigable
...
- formal role assignment and validation steps now live in the operations runbook: [Role Authorization Assignment Runbook](../operations/role-authorization-assignment.md)
