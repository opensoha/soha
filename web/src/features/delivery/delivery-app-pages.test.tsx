...
describe('ApplicationsPage workspace layout', () => {
  ...
  it('renders application-centered cards before the detailed table', async () => {
    ...
    expect(container.querySelector('.kc-application-card-grid')).not.toBeNull()
    expect(container.querySelector('.kc-application-create-card')).toBeNull()
    ...
    expect(container.querySelector('.kc-admin-table-shell')).toBeNull()
  })
})
