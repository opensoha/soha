...
export const consolePermissionGroups: PermissionCatalogGroup[] = [
  ...
  },
  {
    key: "docker",
    label: "Docker 工作台",
    description: "控制 Docker 主机、Compose 项目、服务、端口、模板和操作记录能力。",
    options: [
      ...
      { value: "docker.projects.view", label: "查看 Compose 项目" },
      { value: "docker.projects.manage", label: "管理 Compose 项目" },
      { value: "docker.projects.deploy", label: "部署 Compose 项目" },
      { value: "docker.services.view", label: "查看容器服务" },
      { value: "docker.services.manage", label: "管理容器服务" },
      { value: "docker.ports.view", label: "查看端口映射" },
      { value: "docker.ports.manage", label: "管理端口映射" },
