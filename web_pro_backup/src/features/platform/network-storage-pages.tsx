...
export function ServiceDetailPage({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className="kc-page">
      ...
      {embedded ? (
        ...
        >
          <Text type="secondary">
            {localeCode === 'zh_CN' ? '查看服务暴露信息、后端 Pod、事件与指标。' : 'Inspect service exposure, backend pods, events, and metrics.'}
          </Text>
        </Card>
      ) : null}
      <Tabs
