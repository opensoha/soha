...
const (
	...
	PermDeliveryApplicationEnvApprove      = "delivery.application-environments.approve"
	...
	PermNetworkAccessAccessGrantsCreate    = "network_access.access_grants.create"
	PermNetworkAccessAccessGrantsRevoke    = "network_access.access_grants.revoke"
	PermNetworkAccessAccessGrantsView      = "network_access.access_grants.view"
	PermNetworkAccessEndpointDevicesUpdate = "network_access.endpoint_devices.update"
	PermNetworkAccessEndpointDevicesView   = "network_access.endpoint_devices.view"
	PermNetworkAccessEnrollmentsCreate     = "network_access.enrollments.create"
	PermNetworkAccessEnrollmentsRevoke     = "network_access.enrollments.revoke"
	PermNetworkAccessEnrollmentsView       = "network_access.enrollments.view"
	PermNetworkAccessGatewaysCreate        = "network_access.gateways.create"
	PermNetworkAccessGatewaysUpdate        = "network_access.gateways.update"
	PermNetworkAccessGatewaysView          = "network_access.gateways.view"
	PermNetworkAccessMihomoProfilesCreate  = "network_access.mihomo_profiles.create"
	PermNetworkAccessMihomoProfilesDelete  = "network_access.mihomo_profiles.delete"
	PermNetworkAccessMihomoProfilesUpdate  = "network_access.mihomo_profiles.update"
	PermNetworkAccessMihomoProfilesView    = "network_access.mihomo_profiles.view"
	PermNetworkAccessPolicyCreate          = "network_access.policy.create"
	PermNetworkAccessPolicyDelete          = "network_access.policy.delete"
	PermNetworkAccessPolicyUpdate          = "network_access.policy.update"
	PermNetworkAccessPolicyView            = "network_access.policy.view"
	PermNetworkAccessResourcesCreate       = "network_access.resources.create"
	PermNetworkAccessResourcesDelete       = "network_access.resources.delete"
	PermNetworkAccessResourcesUpdate       = "network_access.resources.update"
	PermNetworkAccessResourcesView         = "network_access.resources.view"
	PermNetworkAccessSitesCreate           = "network_access.sites.create"
	PermNetworkAccessSitesDelete           = "network_access.sites.delete"
	PermNetworkAccessSitesUpdate           = "network_access.sites.update"
	PermNetworkAccessSitesView             = "network_access.sites.view"
	PermNetworkAccessSpacesCreate          = "network_access.spaces.create"
	PermNetworkAccessSpacesDelete          = "network_access.spaces.delete"
	PermNetworkAccessSpacesUpdate          = "network_access.spaces.update"
	PermNetworkAccessSpacesView            = "network_access.spaces.view"
	PermNetworkAccessTelemetryView         = "network_access.telemetry.view"
...
var allPermissionKeySet = []string{
	...
	PermDeliveryApplicationEnvApprove,
