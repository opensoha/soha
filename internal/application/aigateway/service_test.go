	...
	service := newTestService(appaccess.NewPermissionResolver(stubRolePermissionReader{
		matrix: map[string][]string{
			"developer": {
				...
				appaccess.PermPlatformPodsLogs,
				appaccess.PermDeliveryApplicationsView,
			},
		},
	}), nil, repo)
	...
	service := newTestService(appaccess.NewPermissionResolver(stubRolePermissionReader{
		matrix: map[string][]string{
			"sre": {
				appaccess.PermAIGatewayInvoke,
				appaccess.PermWorkspaceResourceView,
				appaccess.PermPlatformDeploymentView,
				appaccess.PermPlatformPodsView,
				appaccess.PermPlatformWorkloadsOverviewView,
				appaccess.PlatformActionPermission("network", "Service", "view"),
	...
	service := newTestService(appaccess.NewPermissionResolver(stubRolePermissionReader{
		matrix: map[string][]string{
			"sre": {
				...
				appaccess.PermPlatformWorkloadsOverviewView,
				appaccess.PlatformActionPermission("configuration", "ConfigMap", "view"),
				appaccess.PlatformActionPermission("configuration", "Secret", "view"),
