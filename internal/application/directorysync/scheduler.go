...
func cronMatches(expression string, at time.Time) bool { return cron.Matches(expression, at) }

func ValidateSchedule(expression string) error { return cron.Validate(expression) }
