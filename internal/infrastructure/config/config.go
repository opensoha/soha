...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("auth.dev_principal.user_id", "local-admin")
	v.SetDefault("auth.dev_principal.name", "Local Admin")
	v.SetDefault("auth.dev_principal.email", "admin@kubecrux.local")
	v.SetDefault("auth.dev_principal.password", "change-me-please")
