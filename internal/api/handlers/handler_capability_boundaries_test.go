...
func TestHandlerCapabilityInterfacesStayFocused(t *testing.T) {
	...
	interfaces := map[string]reflect.Type{
		...
		"DockerOverviewService":           reflect.TypeOf((*DockerOverviewService)(nil)).Elem(),
		...
		"VirtualizationOverviewService":   reflect.TypeOf((*VirtualizationOverviewService)(nil)).Elem(),
