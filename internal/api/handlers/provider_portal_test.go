...
func TestOIDCAuthorizeRedirectsSafeOAuthError(t *testing.T) {
	gin.SetMode(gin.TestMode)
	handler := NewProviderPortalHandler(nil, &stubProviderPortalIdentityProvider{
...
func (s *stubProviderPortalIdentityProvider) ListProviders(context.Context, domainidentity.Principal, domainprovider.ProviderFilter) ([]domainprovider.Provider, error) {
	return nil, apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) GetProvider(context.Context, domainidentity.Principal, string) (domainprovider.Provider, error) {
	return domainprovider.Provider{}, apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) CreateProvider(context.Context, domainidentity.Principal, domainprovider.ProviderInput) (domainprovider.Provider, error) {
	return domainprovider.Provider{}, apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) UpdateProvider(context.Context, domainidentity.Principal, string, domainprovider.ProviderInput) (domainprovider.Provider, error) {
	return domainprovider.Provider{}, apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) DeleteProvider(context.Context, domainidentity.Principal, string) error {
	return apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) ListOutposts(context.Context, domainidentity.Principal, domainprovider.OutpostFilter) ([]domainprovider.Outpost, error) {
	return nil, apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) GetOutpost(context.Context, domainidentity.Principal, string) (domainprovider.Outpost, error) {
	return domainprovider.Outpost{}, apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) CreateOutpost(context.Context, domainidentity.Principal, domainprovider.OutpostInput) (domainprovider.Outpost, error) {
	return domainprovider.Outpost{}, apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) UpdateOutpost(context.Context, domainidentity.Principal, string, domainprovider.OutpostInput) (domainprovider.Outpost, error) {
	return domainprovider.Outpost{}, apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) DeleteOutpost(context.Context, domainidentity.Principal, string) error {
	return apperrors.ErrUnsupportedOperation
}
...
func (s *stubProviderPortalIdentityProvider) ListOIDCClients(context.Context, domainidentity.Principal, string) ([]domainprovider.OIDCClient, error) {
	return nil, apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) CreateOIDCClient(context.Context, domainidentity.Principal, string, domainprovider.OIDCClientInput) (domainprovider.OIDCClientCreated, error) {
	return domainprovider.OIDCClientCreated{}, apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) UpdateOIDCClient(context.Context, domainidentity.Principal, string, domainprovider.OIDCClientInput) (domainprovider.OIDCClient, error) {
	return domainprovider.OIDCClient{}, apperrors.ErrUnsupportedOperation
}

func (s *stubProviderPortalIdentityProvider) DeleteOIDCClient(context.Context, domainidentity.Principal, string) error {
	return apperrors.ErrUnsupportedOperation
}
