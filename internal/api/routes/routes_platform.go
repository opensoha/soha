...
func registerPlatformWorkloadRoutes(protected gin.IRoutes, deps Dependencies) {
	...
	protected.GET("/clusters/:clusterID/workloads/replicasets/:replicaSetName/detail", deps.Platform.GetReplicaSetDetail)
	...
	protected.GET("/clusters/:clusterID/workloads/replicationcontrollers/:name/detail", deps.Platform.GetReplicationControllerDetail)
	protected.GET("/clusters/:clusterID/workloads/replicationcontrollers/:name/yaml", deps.Platform.GetReplicationControllerYAML)
	protected.PUT("/clusters/:clusterID/workloads/replicationcontrollers/:name/yaml", deps.Platform.ApplyReplicationControllerYAML)
...
func registerPlatformConfigurationRoutes(protected gin.IRoutes, deps Dependencies) {
	...
	protected.GET("/clusters/:clusterID/configuration/hpas/:name/detail", deps.Platform.GetHorizontalPodAutoscalerDetail)
	protected.GET("/clusters/:clusterID/configuration/poddisruptionbudgets", deps.Platform.ListPodDisruptionBudgets)
	protected.GET("/clusters/:clusterID/configuration/poddisruptionbudgets/:name/detail", deps.Platform.GetPodDisruptionBudgetDetail)
	...
	protected.GET("/clusters/:clusterID/configuration/mutatingwebhookconfigurations/:name/detail", deps.Platform.GetMutatingWebhookConfigurationDetail)
	...
	protected.GET("/clusters/:clusterID/configuration/validatingwebhookconfigurations/:name/detail", deps.Platform.GetValidatingWebhookConfigurationDetail)
	protected.GET("/clusters/:clusterID/configuration/resourcequotas", deps.Platform.ListResourceQuotas)
	protected.GET("/clusters/:clusterID/configuration/resourcequotas/:name/detail", deps.Platform.GetResourceQuotaDetail)
	protected.GET("/clusters/:clusterID/configuration/limitranges", deps.Platform.ListLimitRanges)
	protected.GET("/clusters/:clusterID/configuration/limitranges/:name/detail", deps.Platform.GetLimitRangeDetail)
...
func registerPlatformNetworkStorageRoutes(protected gin.IRoutes, deps Dependencies) {
	...
	protected.GET("/clusters/:clusterID/network/services/:serviceName/detail", deps.Platform.GetServiceDetail)
	...
	protected.GET("/clusters/:clusterID/network/ingresses/:name/detail", deps.Platform.GetIngressDetail)
	protected.GET("/clusters/:clusterID/network/endpointslices", deps.Platform.ListEndpointSlices)
	protected.GET("/clusters/:clusterID/network/endpointslices/:name/detail", deps.Platform.GetEndpointSliceDetail)
	protected.GET("/clusters/:clusterID/network/networkpolicies", deps.Platform.ListNetworkPolicies)
	protected.GET("/clusters/:clusterID/network/networkpolicies/:name/detail", deps.Platform.GetNetworkPolicyDetail)
	protected.GET("/clusters/:clusterID/network/gatewayclasses", deps.Platform.ListGatewayClasses)
	protected.GET("/clusters/:clusterID/network/gatewayclasses/:name/detail", deps.Platform.GetGatewayClassDetail)
	protected.GET("/clusters/:clusterID/network/gateways", deps.Platform.ListGateways)
	protected.GET("/clusters/:clusterID/network/gateways/:name/detail", deps.Platform.GetGatewayDetail)
	protected.GET("/clusters/:clusterID/network/httproutes", deps.Platform.ListHTTPRoutes)
	protected.GET("/clusters/:clusterID/network/httproutes/:name/detail", deps.Platform.GetHTTPRouteDetail)
	protected.GET("/clusters/:clusterID/network/backendtlspolicies", deps.Platform.ListBackendTLSPolicies)
	protected.GET("/clusters/:clusterID/network/backendtlspolicies/:name/detail", deps.Platform.GetBackendTLSPolicyDetail)
	protected.GET("/clusters/:clusterID/network/grpcroutes", deps.Platform.ListGRPCRoutes)
	protected.GET("/clusters/:clusterID/network/grpcroutes/:name/detail", deps.Platform.GetGRPCRouteDetail)
	protected.GET("/clusters/:clusterID/network/referencegrants", deps.Platform.ListReferenceGrants)
	protected.GET("/clusters/:clusterID/network/referencegrants/:name/detail", deps.Platform.GetReferenceGrantDetail)
	protected.GET("/clusters/:clusterID/network/ingressclasses", deps.Platform.ListIngressClasses)
	protected.GET("/clusters/:clusterID/network/ingressclasses/:name/detail", deps.Platform.GetIngressClassDetail)
