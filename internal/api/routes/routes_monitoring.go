...
func registerObservabilityRoutes(protected gin.IRoutes, deps Dependencies) {
	...
	protected.GET("/observability/providers", deps.Observability.ListProviders)
	protected.GET("/observability/dashboards", deps.Observability.ListDashboards)
	protected.GET("/observability/metrics/data-sources", deps.Observability.ListMetricDataSources)
	protected.GET("/observability/metrics/catalog", deps.Observability.ListMetricCatalog)
	protected.GET("/observability/services", deps.Observability.ListServices)
	protected.GET("/observability/services/:serviceID", deps.Observability.GetService)
	protected.GET("/observability/services/:serviceID/topology", deps.Observability.GetServiceTopology)
	protected.POST("/observability/dashboards/imports", deps.Observability.ImportGrafanaDashboard)
	protected.GET("/observability/dashboards/:dashboardID", deps.Observability.GetDashboard)
	protected.DELETE("/observability/dashboards/:dashboardID", deps.Observability.DeleteDashboard)
	protected.POST("/observability/dashboards/:dashboardID/panels/:panelID/query", deps.Observability.QueryDashboardPanel)
	protected.POST("/observability/metrics/query", deps.Observability.QueryMetrics)
	protected.POST("/observability/traces/query", deps.Observability.QueryTraces)
