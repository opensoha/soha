...
func registerDirectorySyncRoutes(protected gin.IRoutes, deps Dependencies) {
	...
	protected.GET("/access/directory-connections/:connectionID/runtime-status", h.RuntimeStatus)
	protected.GET("/access/directory-connections/:connectionID/events", h.ListEvents)
	protected.POST("/access/directory-connections/:connectionID/events/:eventID/retry", h.RetryEvent)
