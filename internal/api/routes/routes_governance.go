...
func registerSystemRoutes(protected gin.IRoutes, deps Dependencies) {
	...
	protected.GET("/announcements/:announcementID/receipts", deps.Announcements.Receipts)
...
func registerAIGatewayManagementRoutes(protected gin.IRoutes, deps Dependencies) {
	...
	protected.POST("/ai-gateway/relay/upstreams/test", deps.AIGateway.TestLLMUpstreamDraft)
