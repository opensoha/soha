...
func seedMenus(ctx context.Context, db *gorm.DB) error {
	...
	items := []menuSeed{
		...
		{ID: "access", Path: "/access", LabelZH: "权限", LabelEN: "Access", IconKey: "shield", Section: "control", SortOrder: 240, Enabled: true, Roles: []string{"admin"}},
		...
		{ID: "access-teams", ParentID: "access", Path: "/access/teams", LabelZH: "组织", LabelEN: "Teams", IconKey: "shield", Section: "control", SortOrder: 243, Enabled: true, Roles: []string{"admin"}},
