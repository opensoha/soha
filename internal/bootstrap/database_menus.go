...
var builtinMenuSeeds = []menuSeed{
	...
	{ID: "monitoring-workbench-traces", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/traces", LabelZH: "链路", LabelEN: "Traces", IconKey: "network", Section: "observe-signals", SortOrder: 64, Enabled: true},
	{ID: "monitoring-workbench-logs", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/logs", LabelZH: "日志", LabelEN: "Logs", IconKey: "history", Section: "observe-signals", SortOrder: 65, Enabled: true},
	{ID: "monitoring-workbench-providers", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/providers", LabelZH: "Provider", LabelEN: "Providers", IconKey: "puzzle", Section: "observe-data", SortOrder: 66, Enabled: true},
	{ID: "monitoring-workbench-log-data-sources", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/log-data-sources", LabelZH: "日志数据源", LabelEN: "Log Data Sources", IconKey: "server", Section: "observe-data", SortOrder: 67, Enabled: true},
	{ID: "monitoring-workbench-integrations", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/integrations", LabelZH: "告警集成", LabelEN: "Alert Integrations", IconKey: "link", Section: "observe-data", SortOrder: 68, Enabled: true},
	{ID: "monitoring-workbench-alerting", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/alerting", LabelZH: "告警总览", LabelEN: "Alerting Overview", IconKey: "siren", Section: "alerting", SortOrder: 69, Enabled: true},
	{ID: "monitoring-workbench-rules", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/rules", LabelZH: "告警规则", LabelEN: "Alert Rules", IconKey: "siren", Section: "alerting", SortOrder: 70, Enabled: true},
	{ID: "monitoring-workbench-alerts", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/alerts", LabelZH: "活跃告警", LabelEN: "Active Alerts", IconKey: "siren", Section: "alerting", SortOrder: 71, Enabled: true},
	{ID: "monitoring-workbench-notifications", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/notifications", LabelZH: "通知策略", LabelEN: "Notification Policies", IconKey: "bell", Section: "alerting", SortOrder: 72, Enabled: true},
	{ID: "monitoring-workbench-healing", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/healing", LabelZH: "自愈中心", LabelEN: "Healing Center", IconKey: "activity", Section: "alerting", SortOrder: 73, Enabled: true},
	{ID: "monitoring-workbench-oncall", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/oncall", LabelZH: "值班协同", LabelEN: "On-Call Coordination", IconKey: "users", Section: "alerting", SortOrder: 74, Enabled: true},
	{ID: "monitoring-workbench-events", ParentID: "monitoring-workbench", Path: "/monitoring-workbench/events", LabelZH: "事件流", LabelEN: "Events", IconKey: "bell", Section: "alerting", SortOrder: 75, Enabled: true},
	...
	{ID: "virtualization-workbench-operations", ParentID: "virtualization-workbench", Path: "/compute/tasks?domain=virtualization", LabelZH: "操作记录", LabelEN: "Operations", IconKey: "history", Section: "virtualization", SortOrder: 17, Enabled: true},
	{ID: "virtualization-workbench-sync", ParentID: "virtualization-workbench", Path: "/compute/tasks?domain=virtualization&category=sync", LabelZH: "同步任务", LabelEN: "Sync Tasks", IconKey: "sync", Section: "virtualization", SortOrder: 18, Enabled: true},
