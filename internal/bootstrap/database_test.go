...
func TestDefaultMenuSeedsIncludeUnifiedAIWorkbench(t *testing.T) {
	...
	children := map[string]struct {
		...
		"ai-workbench-mcp":             {path: "/ai-workbench/mcp", section: "ai-engineering"},
		"ai-workbench-data-sources":    {path: "/ai-workbench/data-sources", section: "ai-engineering"},
		"ai-workbench-skills":          {path: "/ai-workbench/skills", section: "ai-engineering"},
