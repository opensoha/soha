...
-- Name: ai_gateway_llm_upstreams; Type: TABLE; Schema: public; Owner: -

CREATE TABLE public.ai_gateway_llm_upstreams (
    id text NOT NULL,
    name text NOT NULL,
    provider_kind text NOT NULL,
...
-- Name: ai_gateway_llm_model_routes; Type: TABLE; Schema: public; Owner: -

CREATE TABLE public.ai_gateway_llm_model_routes (
    id text NOT NULL,
...
-- Name: ai_gateway_llm_call_logs; Type: TABLE; Schema: public; Owner: -

CREATE TABLE public.ai_gateway_llm_call_logs (
    id text NOT NULL,
    request_id text,
    actor_type text,
    actor_id text,
...
-- Name: ai_gateway_llm_cache_entries; Type: TABLE; Schema: public; Owner: -

CREATE TABLE public.ai_gateway_llm_cache_entries (
    id text NOT NULL,
...
-- Name: ai_gateway_llm_health_events; Type: TABLE; Schema: public; Owner: -

CREATE TABLE public.ai_gateway_llm_health_events (
    id text NOT NULL,
    upstream_id text,
    upstream_name text,
    provider_kind text,
...
-- Name: ai_gateway_llm_upstreams ai_gateway_llm_upstreams_pkey; Type: CONSTRAINT; Schema: public; Owner: -

ALTER TABLE ONLY public.ai_gateway_llm_upstreams
    ADD CONSTRAINT ai_gateway_llm_upstreams_pkey PRIMARY KEY (id);


-- Name: ai_gateway_llm_model_routes ai_gateway_llm_model_routes_pkey; Type: CONSTRAINT; Schema: public; Owner: -

ALTER TABLE ONLY public.ai_gateway_llm_model_routes
    ADD CONSTRAINT ai_gateway_llm_model_routes_pkey PRIMARY KEY (id);


-- Name: ai_gateway_llm_call_logs ai_gateway_llm_call_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -

ALTER TABLE ONLY public.ai_gateway_llm_call_logs
    ADD CONSTRAINT ai_gateway_llm_call_logs_pkey PRIMARY KEY (id);


-- Name: ai_gateway_llm_cache_entries ai_gateway_llm_cache_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: -

ALTER TABLE ONLY public.ai_gateway_llm_cache_entries
    ADD CONSTRAINT ai_gateway_llm_cache_entries_pkey PRIMARY KEY (id);


-- Name: ai_gateway_llm_health_events ai_gateway_llm_health_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -

ALTER TABLE ONLY public.ai_gateway_llm_health_events
    ADD CONSTRAINT ai_gateway_llm_health_events_pkey PRIMARY KEY (id);
...
-- Name: idx_ai_gateway_llm_upstreams_provider_status; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_upstreams_provider_status ON public.ai_gateway_llm_upstreams USING btree (provider_kind, status);


-- Name: idx_ai_gateway_llm_model_routes_public_enabled; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_model_routes_public_enabled ON public.ai_gateway_llm_model_routes USING btree (public_model, enabled);


-- Name: idx_ai_gateway_llm_model_routes_upstream; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_model_routes_upstream ON public.ai_gateway_llm_model_routes USING btree (upstream_id);


-- Name: idx_ai_gateway_llm_call_logs_created_at; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_call_logs_created_at ON public.ai_gateway_llm_call_logs USING btree (created_at DESC);


-- Name: idx_ai_gateway_llm_call_logs_actor; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_call_logs_actor ON public.ai_gateway_llm_call_logs USING btree (actor_type, actor_id, created_at DESC);


-- Name: idx_ai_gateway_llm_call_logs_token; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_call_logs_token ON public.ai_gateway_llm_call_logs USING btree (token_id, created_at DESC);


-- Name: idx_ai_gateway_llm_call_logs_public_model; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_call_logs_public_model ON public.ai_gateway_llm_call_logs USING btree (public_model, created_at DESC);


-- Name: idx_ai_gateway_llm_call_logs_upstream; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_call_logs_upstream ON public.ai_gateway_llm_call_logs USING btree (upstream_id, created_at DESC);


-- Name: idx_ai_gateway_llm_call_logs_status; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_call_logs_status ON public.ai_gateway_llm_call_logs USING btree (status, created_at DESC);


-- Name: idx_ai_gateway_llm_cache_entries_cache_key; Type: INDEX; Schema: public; Owner: -

CREATE UNIQUE INDEX idx_ai_gateway_llm_cache_entries_cache_key ON public.ai_gateway_llm_cache_entries USING btree (cache_key);


-- Name: idx_ai_gateway_llm_cache_entries_model; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_cache_entries_model ON public.ai_gateway_llm_cache_entries USING btree (public_model, status, updated_at DESC);


-- Name: idx_ai_gateway_llm_cache_entries_upstream; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_cache_entries_upstream ON public.ai_gateway_llm_cache_entries USING btree (upstream_id, updated_at DESC);


-- Name: idx_ai_gateway_llm_cache_entries_expires; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_cache_entries_expires ON public.ai_gateway_llm_cache_entries USING btree (expires_at);


-- Name: idx_ai_gateway_llm_health_events_upstream; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_health_events_upstream ON public.ai_gateway_llm_health_events USING btree (upstream_id, created_at DESC);


-- Name: idx_ai_gateway_llm_health_events_status; Type: INDEX; Schema: public; Owner: -

CREATE INDEX idx_ai_gateway_llm_health_events_status ON public.ai_gateway_llm_health_events USING btree (status, created_at DESC);
...
-- Name: ai_gateway_llm_model_routes ai_gateway_llm_model_routes_upstream_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -

ALTER TABLE ONLY public.ai_gateway_llm_model_routes
    ADD CONSTRAINT ai_gateway_llm_model_routes_upstream_id_fkey FOREIGN KEY (upstream_id) REFERENCES public.ai_gateway_llm_upstreams(id) ON DELETE SET NULL;


-- Name: ai_gateway_llm_cache_entries ai_gateway_llm_cache_entries_upstream_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -

ALTER TABLE ONLY public.ai_gateway_llm_cache_entries
    ADD CONSTRAINT ai_gateway_llm_cache_entries_upstream_id_fkey FOREIGN KEY (upstream_id) REFERENCES public.ai_gateway_llm_upstreams(id) ON DELETE SET NULL;
